...
if __name__ == '__main__':
    ...
    print(f'Iteraciones busqueda lineal: {iter_lin} con una Complejidad Algoritmica de O(n)')
    print(f'Iteraciones busqueda binaria: {iter_bin} con una Complejidad Algoritmica de O(log(n))')
